        ...
        <div class="d-flex justify-content-center">
            <div class="col-10" style="padding : 0;">
                ...
                <table class="table table-hover mt-2">
                    ...
                    <tbody>
                        <tr>
                            <td class="text-center">Fiscalia de sustancias controladas</td>
                            <td class="text-center">Calle Baldivieso</td>
                            <td class="text-center">4447655</td>
                            <td class="text-center">
                            <a href="" title="Editar" data-toggle="modal" data-target="#modalEditarUnidad"><i class="far fa-edit"></i></a>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form>
                        <div class="form-group">
                            <input type="text" class="form-control" placeholder="Nombre Unidad" required>
                        </div>
                        <div class="form-group">
